...
export default function SuccessStoryForm() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const imageBase64 = formData.photo ? await convertToBase64(formData.photo) : null;
                    ...
                    <div className="card-body">
                        {showSuccessMessage && (
                            <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
                                ...
                                <span className="block sm:inline"> Your success story has been submitted.</span>
                            </div>
                        )}
                        <form onSubmit={handleSubmit}>
                            ...
                            {/* Calamity Name */}
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="calamityName">
                            ...
                            {/* Control Number */}
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="controlNumber">
                            ...
                            {/* Transaction IDs */}
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="transactionIds">
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="numberOfRecipients">
                                    Number of Recipients
                                </label>
                                <input
                                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
