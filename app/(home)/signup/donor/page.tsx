      ...
      {showPrivacyModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <div className="overflow-y-auto h-64 mb-4">
              <p>Your privacy is important to us. This Privacy Policy explains how we collect, use, and share your information when you use HirayaLink.</p>

              <h3 className="font-semibold mt-2">1. Information We Collect</h3>
              <p>We collect information you provide directly, such as when you register, sign up for our service, or communicate with us.</p>
              ...
              <h3 className="font-semibold mt-2">3. Sharing Your Information</h3>
            ...
            <button className="btn btn-primary w-full" onClick={togglePrivacyModal}>
              Close
            </button>
          </div>
        </div>
