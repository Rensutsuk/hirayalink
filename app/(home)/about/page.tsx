      ...
      <div className="px-4 sm:px-8 lg:px-12 mt-8">
        <div className="max-w-3xl mx-auto">
          <p className="text-center text-gray-700 text-base md:text-lg">
			...
			<div className="divider divider-primary mx-10"></div>

      <div className="py-8 px-4 sm:px-8 lg:px-12">
        <div className="relative">
          <div className="text-center mb-8">
            <p className="text-3xl font-bold text-primary">Our Goals</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="text-center">
              <div className="bg-primary p-4 rounded-md mx-auto w-full max-w-[800px]">
