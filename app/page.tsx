    ...
    <main>
      ...
      <div className="flex flex-col">
        ...
        <div className="text-center text-slate-700">
          ...
          <a role="button" className="btn btn-outline btn-wide mt-10" href='/donation-request-posting'>
            Learn More
          </a>
        </div>
      </div>
      <div className="flex grid grid-flow-row py-20 auto-rows-max justify-center bg-gradient-to-t from-transparent from-5% via-green-300 via-85% to-transparent to-100%">
